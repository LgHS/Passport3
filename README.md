...
- **Commercial license required** to sell it, host it for third parties as part of a commercial offering, or embed it in a commercial product. Contact: admin@lghs.be.
