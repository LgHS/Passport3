...
En soumettant une pull request, vous acceptez le [contrat de licence des contributeurs](CLA.md) (commentez la phrase d'acceptation indiquée à la fin de ce fichier sur votre première PR).
